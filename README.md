...
## Data preaparation and descriptive analysis
  ...
  - Following which Table 1 (stratified by outcome) is produced and outputted to your local machine in the ```Tables.R```.
